...
<div class="card">
	<div class="card-header" style="background-color: #00838f ;">
		<div class="row">
			<div class="col-md-6">
				<h4 class="title">Trazo y Corte</h4>
				<p class="category">Introducción</p>
			</div>
			<div class="col-md-6">
	...
	<div class="card-content table-responsive">
		<h4 class="flow-text parrafo_intro">
			...
			El trabajo es un aporte del equipo para el proceso de aprendizaje del área de trazo y corte Industrial que sirve el SENA a través del Centro de Confecciones.
		</h4>
